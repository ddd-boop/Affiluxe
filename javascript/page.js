...
document.getElementById("notifications").onclick=function() {
    document.getElementById("notify").style.height="109%";
};
...
document.getElementById("invest").onclick=function() {
    document.getElementById("invester").style.height="109%";
};


document.getElementById("spin").onclick=function() {
    document.getElementById("spin-to").style.height="109%";
...
document.getElementById("sponsor").onclick=function() {
    document.getElementById("sponsorer").style.height="109%";
};



document.getElementById("daily").onclick=function() {
    document.getElementById("dailly").style.height = "109%";
...
alert("withdrawal can not be made until futher notice if you wish to continue click OK")
    document.getElementById("withdrawal").style.height="109%";
};



document.getElementById("upgrade").onclick=function() {
    document.getElementById("upgrades").style.height="109%";
};
...
function processWithdrawal() {
    ...
    const currentUser = localStorage.getItem('currentUser');
        ...
        if (lastTaskTime && new Date().getTime() - lastTaskTime <   1* 1000) {
